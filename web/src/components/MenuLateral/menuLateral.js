...
export default function MenuLateral() {
  ...
  const [openModalAgentPlayer, setOpenModalAgentPlayer] = useState(false);
  const [openModalEditAgentPlayer, setOpenModalEditAgentPlayer] = useState(
    false
  );
  ...
  return (
    <>
      ...
      {/*  <img
          ...
          src={fotoPerfil ? fotoPerfil : AvatarImg}
        ></img> */}
      {/*    </Paper> */}
      ...
      <NewAgentPlayerModal
        openModalAgentPlayer={openModalAgentPlayer}
        setOpenModalAgentPlayer={setOpenModalAgentPlayer}
      />

      <EditAgentPlayerModal
        openModalEditAgentPlayer={openModalEditAgentPlayer}
        setOpenModalEditAgentPlayer={setOpenModalEditAgentPlayer}
      />
    </>
  );
}
