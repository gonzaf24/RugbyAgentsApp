...
export const ClubProfile = () => {
  ...
  const maxStepsVideos = user.club.videos ? user.club.videos.length : null;
            ...
            <CardActionArea className={classes.bottom}>
              <div className={classes.cardFondoAvatar}>
                <div className={classes.align}>
                  <img
                    ...
                    alt={user.club.nombre}
                    src={user.club.fotoPerfil}
                  />
                </div>

                <Typography component="h2" className={classes.center}>
                  {user.club.nombre.toUpperCase()}
                </Typography>
              </div>
              ...
              <CardContent>
                <div>
                    ...
                    >
                      <TableBody className={classes.tableBody}>
                        ...
                        <TableRow key={t("txt.country")}>
                          ...
                          <TableCell align="left">{user.club.pais}</TableCell>
                        </TableRow>
                        ...
                        <TableRow key={t("txt.web")}>
                          ...
                          <TableCell align="left">{user.club.web}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </TableContainer>
                    ...
                    >
                      <TableBody className={classes.tableBody}>
                        <TableRow key={t("txt.name")}>
                          ...
                          <TableCell align="left">
                            {user.club.responsableContrataciones}
                          </TableCell>
                        </TableRow>
                  ...
                  {user.club.videos && user.club.videos.length > 0 && (
                    <div className={classes.rootPlayer}>
                      ...
                      >
                        <Typography>
                          {user.club.videos[activeStepVideo].nombre}
                        </Typography>
                      </Paper>
                      <ReactPlayer
                        width="100%"
                        height="100%"
                        controls={true}
                        url={user.club.videos[activeStepVideo].link}
                        muted
                        config={{
                          youtube: {
